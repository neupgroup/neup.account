...
export default async function RootLayout({ children }: { children?: React.ReactNode }) {
  ...
  return <AppProviders initialSession={initialSession}><AppTitleSync /><PersistentBacksTo /><PageProgressBar /><div className="flex min-h-screen flex-col"><HeaderV1 logoUrl={logoUrl} /><main className="flex-1 pt-16">{children}</main></div><Toaster /><Suspense><UrlErrorToast /></Suspense></AppProviders>;
}
