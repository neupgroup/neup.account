...
async function main() {
  ...
  await prisma.authzRole.upsert({
    ...
    update: { name: 'individual.root', scope: 'individual.root', appId: 'neup.account' },
    create: { id: 'root-full-neup-account', name: 'individual.root', scope: 'individual.root', appId: 'neup.account' },
  });
