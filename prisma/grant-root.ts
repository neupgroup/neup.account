...
async function main() {
  ...
  await prisma.authzRole.upsert({
    ...
    update: { name: 'individual.root', scope: 'root.individual', appId: 'neup.account' },
    create: { id: 'root-full-neup-account', name: 'individual.root', scope: 'root.individual', appId: 'neup.account' },
  });
