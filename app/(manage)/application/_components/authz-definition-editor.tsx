...
export function AuthzDefinitionEditor({
  ...
  return (
    <div className="grid gap-3 rounded-xl border p-4">
            ...
            <div key={`${label}-${index}`} className="grid gap-3 rounded-lg border p-3">
              ...
              <div className="flex items-center gap-3">
                <Input
                  ...
                  disabled={disabled}
                />
                <Button htmlType="button" variant="plain" size="sm" onClick={() => removeRow(index)} disabled={disabled}>
      ...
      <div>
        <Button htmlType="button" variant="outlined" onClick={addRow} disabled={disabled}>
