        ...
        <div>
            <div className="flex items-center justify-between py-3">
                <div className="flex items-center gap-4">
                 ...
                 <Button variant="plain" size="icon" onClick={handleRemove} disabled={isRemoving} className="h-8 w-8 text-muted-foreground hover:text-destructive">
                    {isRemoving ? <Loader2 className="h-4 w-4 animate-spin" /> : <Trash2 className="h-4 w-4" />}
                </Button>
            </div>
             <div className="flex items-center space-x-2 mt-4 border-t pt-4">
                <Button onClick={handleToggle} variant="outlined" size="sm" disabled={isToggling}>
        ...
        <form ref={formRef} action={handleAddPartner} className="w-full">
            <div className="w-full space-y-2">
                <div className="relative">
                    ...
                    />
                    <Button htmlType="submit" size="icon" variant="plain" className="absolute right-1 top-1/2 h-8 w-8 -translate-y-1/2 text-muted-foreground hover:bg-accent" disabled={isAdding}>
