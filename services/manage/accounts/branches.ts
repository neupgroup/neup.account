    ...
    try {
        ...
        const result = await prisma.$transaction(async (tx) => {
            ...
            await tx.authzRole.upsert({
                ...
                update: { name: 'brand.owner', scope: 'managed.0010', appId: 'neup.account' },
                create: { id: 'brand-owner-neup-account', name: 'brand.owner', scope: 'managed.0010', appId: 'neup.account' },
            });
